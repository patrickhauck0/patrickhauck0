...
The work I'd point at first is my research on agentic software generation:
- **[agentic-llm-webmvc-evaluation](https://github.com/patrickhauck0/agentic-llm-webmvc-evaluation)**: built an empirical evaluation framework assessing LLMs acting as autonomous agents to generate complete web MVC applications. Instead of relying on superficial benchmarks, I set up objective quality gates—measuring architectural adherence, code maintainability via SonarQube static analysis, and formal defect detection using Fagan inspection.
